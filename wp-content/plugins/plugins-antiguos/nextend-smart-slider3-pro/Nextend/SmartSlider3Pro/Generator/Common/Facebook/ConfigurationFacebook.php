...
class ConfigurationFacebook extends AbstractGeneratorGroupConfiguration {
    ...
    public function render($MVCHelper) {
        ...
        if (substr($callBackUrl, 0, 8) !== 'https://') {
            ...
            $warningText = sprintf(n2_('%1$s allows HTTPS Redirect URIs only! You must move your site to HTTPS in order to use this generator! - %2$s How to get SSL for my WordPress site? %3$s'), 'Facebook', '<a href="https://www.wpbeginner.com/wp-tutorials/how-to-add-ssl-and-https-in-wordpress/" target="_blank" rel="nofollow noopener noreferrer">', '</a>');
