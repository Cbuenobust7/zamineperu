<?php
/* Template Name: Elementos de desgaste  */
get_header(); 
  ...
  <div class="banner banner-2">
    ...
    <div class="overlay">
        <?php
          ...
          if ($lang == 'en-US') { 
            echo do_shortcode('[smartslider3 slider="38"]'); }
          if ($lang == 'es-PE') { 
            echo do_shortcode('[smartslider3 slider="37"]'); }
        ?> 
    </div>
  </div>
    ...
    <div>
     <?php
        ...
        if ($lang == 'en-US') { 
          ...
          <li class="breadcrumb-item active" aria-current="page">Tonly</li>
        </ol>
        ...
        if ($lang == 'es-PE') { 
          ...
          <li class="breadcrumb-item active" aria-current="page">Elementos de desgaste</li>
        </ol>
