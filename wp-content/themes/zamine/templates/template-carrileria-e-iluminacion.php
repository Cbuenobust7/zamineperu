<?php
/* Template Name: Carrilería e iluminación  */
get_header(); 
  ...
  <div class="banner banner-2">
    ...
    <div class="overlay">
        <?php
          ...
          if ($lang == 'en-US') { 
            echo do_shortcode('[smartslider3 slider="40"]'); }
          if ($lang == 'es-PE') { 
            echo do_shortcode('[smartslider3 slider="39"]'); }
        ?> 
    </div>
  </div>
    ...
    <div>
     <?php
        ...
        if ($lang == 'es-PE') { 
          ...
          <li class="breadcrumb-item active" aria-current="page">Carrilería e iluminación</li>
        </ol>
