...
.page-news .banner img {
  width: 100%;
  height: auto;
  object-fit: contain; /* Ajusta el tama���o de la imagen para que se contenga dentro del contenedor */
}

.page-news .news-list--item--image {
  position: relative;
  overflow: hidden;
  height: 300px; /* Ajusta esta altura seg���n tus necesidades */
}
...
.page-news .news-list--item--image div {
  ...
  left: 0;
  right: 0;
  background-size: cover; /* Ajusta el tama���o para que la imagen cubra el contenedor */
...
/* A���adir margen inferior a cada elemento de la lista de noticias */
.news-list--item {
  margin-bottom: 30px; /* Ajusta este valor seg���n el espacio deseado */
}
    ...
    <?php foreach ($news as $k => $new) : ?>
      <div class="news-list--item wrapper">
        <div class="row">
          ...
          <div class="col-md-6 <?php echo ($k % 2 != 0) ? 'order-md-2' : '' ?> news-list--item--image">
            <div class="news--item--image mb-2">
              <img src="<?php echo get_the_post_thumbnail_url($new) ?>" class="corrector-sizeNews">
            </div>
          </div>

          <!-- Columna del contenido -->
          <div class="col-md-6 <?php echo ($k % 2 != 0) ? 'order-md-1' : '' ?> news-list--item--content">
            <div class="px-lg-4">
