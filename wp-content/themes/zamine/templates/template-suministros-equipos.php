<?php
/* Template Name: Suministros para equipos  */
get_header(); 
...
<?php
    if ($lang == 'en-US') { 
          echo '<div id="principal" class="wrapper d-flex mb-1">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item active" aria-current="page">Supply for equipment</li>
      </ol>
      </div>'; }
        if ($lang == 'es-PE') { 
          echo   '<div id="principal" class="wrapper d-flex mb-1">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Suministros para equipos</li>
      </ol>
      </div>'; }
      ?>
