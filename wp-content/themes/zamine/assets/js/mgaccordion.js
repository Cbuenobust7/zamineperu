	...
	$.fn.mgaccordion = function (options) {
		...
		this.initialize = function () {
			...
			$.each(this.find('li'), function () {
				...
				if ($this.children('ul').length) {
					...
					if (theme === 'tree') {
						$this.children('a').append('<span class="toggler"><i class="fa fa-plus"></i> </span>');
					} else {
						$this.children('a').append('<span class="toggler"> <i class="fa fa-arrow-down"></i></span>');
					}
				}
			});
		...
		var setIcons = function () {
			if (settings.theme === 'tree') {
				openIcon = '<span class="toggler"><i class="fa fa-plus"></i> </span>';
				closeIcon = '<span class="toggler"><i class="fa fa-minus"></i> </span>';
			} else if (settings.theme === 'flat') {
				openIcon = '<span class="toggler"><i class="fa fa-arrow-down"></i> </span>';
				closeIcon = '<span class="toggler"> <i class="fa fa-arrow-up"></i></span>';
			}
		}
