...
<!--CUASI MAQUETA -->
  ...
  <div class="card">
    ...
    <div id="section0" class="collapse show" aria-labelledby="page0" data-parent="#accordionServices" data-info="info0" data-header="page0">
      <div class="card-body">
        <ul><li> <a href="http://ciem-demo6.com/servicios/camiones-autonomos/">Camiones autónomos</a> </li></ul>
      </div>
    </div>
  </div>  <div class="card">
    ...
    <div id="section1" class="collapse" aria-labelledby="page1" data-parent="#accordionServices" data-info="info1" data-header="page1">
      <div class="card-body">
        <ul><li> <a href="http://ciem-demo6.com/servicios/test/">Palas y escavadoras</a> </li><li> <a href="http://ciem-demo6.com/servicios/camiones-para-gran-altitud/">Camiones para gran altitud</a> </li></ul>
      </div>
    </div>
  </div>  <div class="card">
    ...
    <div id="section2" class="collapse" aria-labelledby="page2" data-parent="#accordionServices" data-info="info2" data-header="page2">
      <div class="card-body">
        <ul><li> <a href="http://ciem-demo6.com/servicios/691/">test</a> </li></ul>
      </div>
    </div>
  </div>
          </div>
